...
- [ ] Click [here](https://tinyurl.com/cloudera-ai-lab) to open a Keycloak login page in a new window to get access into the Cloudera environment. Check with the instructor to get access credentials. Use your unique username and password to login and confirm by checking the profile name after you have logged in. Look at the screenshots below. 
